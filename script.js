...
EVlayer.on('featureClicked', function (event) {
  ...
  if (event.data['image'] == null) {
    content += '<d>Sorry! No image available.</div><br>';
  }
  else {
  ...
  content += '<br><a href="' + event.data['url'] + '" target="_blank"> More information </a>';  
...
IPlayer.on('featureClicked', function (event) {
  ...
  // CODE ADDED BY TAYYAB
  //If you want to move description above the image, cut lines 489-510 and paste them below line 512
  var setImage = false;
  if(content.includes('Walled City')){
      content+='<div><a href = "walledcity.html" target="_blank"><img src = "https://cdn.glitch.com/faafc5b3-b7d6-4aa4-83ce-12e2673c6ebf%2Fwalledcitymin.jpg?1554702634778" width=80% ></a></div>';
      setImage = true;
    }
  else if(content.includes('Chauburji')){
      content+='<div><a href = "chaburji.html" target="_blank"><img src = "https://cdn.glitch.com/faafc5b3-b7d6-4aa4-83ce-12e2673c6ebf%2Fchaburjimin.jpg?1554702635752" width=80% ></a></div>';
      setImage = true;
    }
    
  else if(content.includes('Azadi Chowk Interchange')){
      content+='<div><a href = "azadichowk.html" target="_blank"><img src = "https://cdn.glitch.com/faafc5b3-b7d6-4aa4-83ce-12e2673c6ebf%2Fazadichowkmin.jpg?1554702634983" width=80% ></a></div>';
      setImage = true;
    }
    
  else if(content.includes('Lahore Canotonment Housing Society')){
    content+='<div><a href = "dha.html" target="_blank"><img src = "https://cdn.glitch.com/faafc5b3-b7d6-4aa4-83ce-12e2673c6ebf%2Fdhamin.jpg?1554702635262" width=80% ></a></div>';
    setImage = true;
  }
    
    if(setImage) content+='<br>';
...
ORlayer.on('featureClicked', function (event) {
  ...
  //CODE ADDED BY TAYYAB
  // If you want the image to be below the description, lines 669-673 below 675
  var setImage = false;
  if(content.includes('Walled')){
    content+='<div><a href = "lahorigate.html" target="_blank"><img src = "https://cdn.glitch.com/faafc5b3-b7d6-4aa4-83ce-12e2673c6ebf%2Flahorigatemini.jpg?1554706831942" width=80% ></a></div>';
    setImage = true;
  }
  if(setImage) content += '<br>';
...
content += '<div>Organization type: ' + event.data['organization_type'] + '</div>';
    ...
    content += '<h5>More information here' + ' <h5>';
  //content += '<div>url: ' + event.data['url'] + ' </div>';
